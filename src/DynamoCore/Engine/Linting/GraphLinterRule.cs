...
{
    public abstract class GraphLinterRule : ILinterRule<GraphChangedEventArgs, GraphRuleEvaluationResult>
    {
        ...
        protected GraphLinterRule(string id, string severityCode, string description, string callToAction)
        {
        ...
        public abstract GraphRuleEvaluationResult Evaluate(GraphChangedEventArgs e);
    }
}
